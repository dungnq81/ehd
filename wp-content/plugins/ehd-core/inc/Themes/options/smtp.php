...
<div class="section section-text" id="section_smtp_host">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr($smtp_options['smtp_host']); ?>" class="ehd-input ehd-control" type="text" id="smtp_host" name="smtp-host">
        </div>
...
<div class="section section-text" id="section_smtp_username">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr($smtp_options['smtp_username']); ?>" class="ehd-input ehd-control" type="text" id="smtp_username" name="smtp-username">
        </div>
...
<div class="section section-password" id="section_smtp_password">
    ...
    <div class="option">
        <div class="controls">
            <input value="" class="ehd-input ehd-control" type="password" id="smtp_password" name="smtp-password">
        </div>
...
<div class="section section-text" id="section_smtp_port">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr($smtp_options['smtp_port']); ?>" class="ehd-input ehd-control" type="text" id="smtp_port" name="smtp-port">
        </div>
...
<div class="section section-text" id="section_smtp_from_email">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr($smtp_options['smtp_from_email']); ?>" class="ehd-input ehd-control" type="text" id="smtp_from_email" name="smtp-from-email">
        </div>
...
<div class="section section-text" id="section_smtp_from_name">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr($smtp_options['smtp_from_name']); ?>" class="ehd-input ehd-control" type="text" id="smtp_from_name" name="smtp-from-name">
        </div>
...
<div class="section section-checkbox" id="section_smtp_disable_ssl_verification">
    ...
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="ehd-checkbox ehd-control" name="smtp-disable-ssl-verification" id="smtp_disable_ssl_verification" <?php checked($smtp_options['smtp_disable_ssl_verification'], 1); ?> value="1">
        </div>
