...
if(!isset($smtp_options['smtp_disable_ssl_verification'])) {
    $smtp_options['smtp_disable_ssl_verification'] = '';
}
...
<div class="section section-text" id="section_smtp_host">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr($smtp_options['smtp_host']); ?>" class="ehd-input ehd-control" type="text" id="smtp_host" name="smtp_host">
        </div>
        ...
        <div class="controls">
            <div class="select_wrapper">
                <select class="ehd-control ehd-select" name="smtp_auth" id="smtp_auth">
                    <option value="true"<?php echo selected( $smtp_options['smtp_auth'], 'true', false ); ?>>True</option>
                    <option value="false"<?php echo selected( $smtp_options['smtp_auth'], 'false', false ); ?>>False</option>
                </select>
            </div>
        </div>
...
<div class="section section-text" id="section_smtp_username">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr($smtp_options['smtp_username']); ?>" class="ehd-input ehd-control" type="text" id="smtp_username" name="smtp_username">
        </div>
        ...
        <div class="controls">
            <div class="select_wrapper">
                <select class="ehd-control ehd-select" name="smtp_encryption" id="smtp_encryption">
                    <option value="tls"<?php echo selected( $smtp_options['smtp_encryption'], 'tls', false );?>>TLS</option>
                    <option value="ssl"<?php echo selected( $smtp_options['smtp_encryption'], 'ssl', false );?>>SSL</option>
                    <option value="none"<?php echo selected( $smtp_options['smtp_encryption'], 'none', false );?>>No Encryption</option>
                </select>
            </div>
        </div>
...
<div class="section section-text" id="section_smtp_port">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr($smtp_options['smtp_port']); ?>" class="ehd-input ehd-control" type="text" id="smtp_port" name="smtp_port">
        </div>
...
<div class="section section-text" id="section_smtp_from_email">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr($smtp_options['smtp_from_email']); ?>" class="ehd-input ehd-control" type="text" id="smtp_from_email" name="smtp_from_email">
        </div>
...
<div class="section section-text" id="section_smtp_from_name">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr($smtp_options['smtp_from_name']); ?>" class="ehd-input ehd-control" type="text" id="smtp_from_name" name="smtp_from_name">
        </div>
...
<div class="section section-checkbox" id="section_smtp_disable_ssl_verification">
    ...
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="ehd-checkbox ehd-control" name="smtp_disable_ssl_verification" id="smtp_disable_ssl_verification" <?php checked($smtp_options['smtp_disable_ssl_verification'], 1); ?> value="1">
        </div>
