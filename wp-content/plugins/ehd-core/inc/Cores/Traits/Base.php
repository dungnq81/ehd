...
trait Base
{
     ...
     * @return  bool
     */
    public static function isPhp(string $version = '5.0.0')
    {
        static $phpVer;
     ...
     * @return bool
     */
    public static function inRange(mixed $value, $min, $max)
    {
     ...
     * @return mixed
     */
    public static function sanitizeInput($key, array $request = [])
    {
     ...
     * @return string
     */
    public static function youtubeImage($url, array $resolution = [])
    {
        if (!$url)
            return '';
