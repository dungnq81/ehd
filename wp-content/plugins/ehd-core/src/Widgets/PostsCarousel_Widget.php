...
class PostsCarousel_Widget extends Abstract_Widget {
	public function __construct() {
		...
		$this->settings           = [
			...
			'columns_number'        => [
				...
				'desc'  => __( 'Separated by commas (,) (3 values)', EHD_PLUGIN_TEXT_DOMAIN ),
			],
			'gap'                   => [
				'type'  => 'text',
				'std'   => '0,0',
				'label' => __( 'Gap', EHD_PLUGIN_TEXT_DOMAIN ),
				'desc'  => __( 'Separated by commas (,) (2 values)', EHD_PLUGIN_TEXT_DOMAIN ),
			],
			'rows'                  => [
				'type'  => 'number',
				'min'   => 1,
			...
			'category'              => [
				...
				'desc'  => __( 'Separated by comma (,)', EHD_PLUGIN_TEXT_DOMAIN ),
			],
			'include_children'      => [
				'type'  => 'checkbox',
				'std'   => 0,
	...
	public function widget( $args, $instance ) {
        ...
        <section class="section carousel-section posts-carousel-section posts-section <?= $_class ?>"
			...
			<?php if ( $desc ) {
				echo '<p class="heading-desc">' . $desc . '</p>';
			} ?>
