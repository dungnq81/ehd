...
namespace EHD\Sites\Plugins\Woocommerce;
...
//            });
        ...
        {
            wp_enqueue_style("woocommerce-style", get_template_directory_uri() . '/assets/css/woocommerce.css', ["layout-style"], EHD_THEME_VERSION);
        }
    }
}
