...
namespace EHD\Sites\Plugins\Elementor;
...
if (!class_exists('Elementor_Plugin')) {
    ...
    class Elementor_Plugin
    {
        ...
        {
            wp_enqueue_style("elementor-style", get_template_directory_uri() . '/assets/css/elementor.css', ["layout-style", "elementor-frontend"], EHD_THEME_VERSION);
