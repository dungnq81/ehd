...
if (!function_exists('ehd_get_gallery_image_html')) {
    /**
     * @param      $attachment_id
     ...
     * @return string
     */
    function ehd_get_gallery_image_html($attachment_id, bool $main_image = false, bool $cover = false, bool $lightbox = false)
    {
        ...
        $ratio = Helper::getThemeMod('product_menu_setting');
        $ratio_class = $ratio;
...
if (!function_exists('ehd_sale_flash_percent')) {
    /**
     * @param $product
     * @return float
     */
    function ehd_sale_flash_percent($product)
    {
        global $product;
        $percent_off = '';
...
if (!function_exists('ehd_template_loop_quick_view')) {
    /**
     * Get the quick view template for the loop.
     *
     * @param array $args Arguments.
     */
    function ehd_template_loop_quick_view(array $args = [])
    {
        global $product;
...
add_action('woocommerce_share', 'ehd_woocommerce_share', 11);
if (!function_exists('ehd_woocommerce_share')) {
    /**
     * woocommerce_share action
     * @return void
     */
    function ehd_woocommerce_share()
    {
...
add_action('woocommerce_single_product_summary', 'ehd_template_single_meta_sku', 9);
if (!function_exists('ehd_template_single_meta_sku')) {
    /**
     *
     * Output the product meta.
     */
    function ehd_template_single_meta_sku()
    {
...
add_action('woocommerce_product_video', 'acf_video_product', 21);
if (!function_exists('acf_video_product')) {
    /**
     * @return void
     */
    function acf_video_product()
    {
        global $product;
        $video_link = ehd_video_product($product->get_id(), 'video_link');
        if ($video_link) {
...
if (!function_exists('ehd_video_product')) {
    /**
     * @param        $product_id
     * @param string $acf_field
     * @return false|mixed
     */
    function ehd_video_product($product_id, string $acf_field = 'video_link')
    {
...
add_action('woocommerce_after_single_product_summary', 'ehd_output_recently_viewed_products', 25);
add_action('woocommerce_after_shop', 'ehd_output_recently_viewed_products', 19);
if (!function_exists('ehd_output_recently_viewed_products')) {
    /**
     * Output the product sale flash.
     */
    function ehd_output_recently_viewed_products()
    {
